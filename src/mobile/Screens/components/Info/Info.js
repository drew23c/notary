        ...
        return(
            <View style={styles.container}>
                <View style={{width:'80%', left:-15}}>
                    <Text>Covered by Errors and Omissions Insurance policy for your protection.  I accept major credit and debit card, cash pay, cashier's check</Text>
                    ...
                    <View style={styles.container}>
                        ...
                        <Text>I will arrive at your location prepared and ready to perform any notary service you require. I'll be courteous and arrive on time.</Text>
                    </View>
                    <Image style={{height:50, width:50, marginLeft:140}} source={separator} />
                    <View style={styles.container}>
                        <Text style={styles.title}>Travel to your location</Text>
                        <Image style={{height:100, width:150, borderRadius:25}} source={car} />
                        <Text>I will meet you at your home, office, school, hospital, rehab, assisted living or anywhere that is convenient for you.</Text>
                    </View>
                    <Image style={{height:50, width:50, marginLeft:140}} source={separator} />
                    <View style={styles.container}>
                    ...
                    <View>
                        <Text style={{fontWeight:'bold', marginTop:5}}>Mobile Fingerprinting Specializes In:</Text>
                        <FlatList
                                data={[
                                    {key: 'Contractors'},
                                    {key: 'Heathcare Worker Registry'},
                                    {key: 'Nursing Physician, Medical Industry'},
                                    {key: 'Medical Marijuana'},
                                    {key: 'Adoption'},
                                    {key: 'Security Companies'},
                                    {key: 'Financial Service Companies'},
                                    {key: 'Auto Dealers'},
                                    {key: 'Tow Truck Drivers'},
                                    {key: 'School District/Education'},
                                    {key: 'Employment Agencies'},
                                    {key: 'Liquor Authority'},
                                    {key: 'Legal Professionals'},
                                    {key: 'Passport Pictures'},
